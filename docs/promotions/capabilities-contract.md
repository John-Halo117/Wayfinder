# Promotion Report: Capability Contract

## Summary

Concept promoted: Capability
...
| `contracts/capabilities/README.md` | New or normalized canonical language home. | Created or updated. |

## Dependency Graph

```mermaid
flowchart TD
  constitution["constitution/"] --> contract["contracts/capabilities/"]
...
```mermaid
flowchart TD
  concept["Capability"] --> owner["contracts/capabilities/"]
  owner --> consumers["documented consumers"]
```

## Canonical Owner Verification

Capability is shared architectural language. Its canonical contract home is
`contracts/capabilities/`. Runtime behavior remains with future implementation owners and
...
1. Create or normalize `contracts/capabilities/README.md` as language-only contract documentation.
...
Created or updated `contracts/capabilities/README.md`.
...
Revert `contracts/capabilities/README.md` and this promotion's governance updates.
