# Promotion Report: Capsule Contract

## Summary

Concept promoted: Capsule
...
| `contracts/capsules/README.md` | New or normalized canonical language home. | Created or updated. |

## Dependency Graph

```mermaid
flowchart TD
  constitution["constitution/"] --> contract["contracts/capsules/"]
...
```mermaid
flowchart TD
  concept["Capsule"] --> owner["contracts/capsules/"]
  owner --> consumers["documented consumers"]
```

## Canonical Owner Verification

Capsule is shared architectural language. Its canonical contract home is
`contracts/capsules/`. Runtime behavior remains with future implementation owners and
...
1. Create or normalize `contracts/capsules/README.md` as language-only contract documentation.
...
Created or updated `contracts/capsules/README.md`.
...
Revert `contracts/capsules/README.md` and this promotion's governance updates.
