# Policy Service Rollback Plan

## Rollback Scope

Rollback removes the Wave 2 service scaffold and governance entries for `services/policy/` only.
...
1. Remove `services/policy/` scaffold files.
