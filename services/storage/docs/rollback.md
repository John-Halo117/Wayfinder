# Storage Service Rollback Plan

## Rollback Scope

Rollback removes the Wave 2 service scaffold and governance entries for `services/storage/` only.
...
1. Remove `services/storage/` scaffold files.
