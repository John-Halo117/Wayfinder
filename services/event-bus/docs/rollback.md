# Event Bus Service Rollback Plan

## Rollback Scope

Rollback removes the Wave 2 service scaffold and governance entries for `services/event-bus/` only.
...
1. Remove `services/event-bus/` scaffold files.
