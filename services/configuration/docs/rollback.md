# Configuration Service Rollback Plan

## Rollback Scope

Rollback removes the Wave 2 service scaffold and governance entries for `services/configuration/` only.
...
1. Remove `services/configuration/` scaffold files.
